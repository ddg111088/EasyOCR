...
icon = Image.open(r"E:\pythonProject1\bussiness.png")
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR | By Dhananjay Gothankar",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Dhananjay Gothankar*!"""})
...
if selected == "Home":
    ...
    with col2:
        image1=Image.open(r"E:\pythonProject1\bussiness.png")
        st.image(image1)

# UPLOAD AND EXTRACT MENU
if selected == "Upload & Extract":
    st.markdown("### Upload a Business Card")
    uploaded_card = st.file_uploader("upload here", label_visibility="collapsed", type=["png", "jpeg", "jpg"], key="my_file_uploader")
